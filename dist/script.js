...
var test = function test() {
  ...
  var printText = document.querySelector(".print__text");
  var prinSubtText = document.querySelector(".print__subtext");
  var gridItem = document.querySelectorAll(".grid__item");
  ...
  window.addEventListener("scroll", function (e) {
    ...
    circle.style.cssText = "  \n\t\t\ttop: ".concat(topValue < 0 ? 0 : topValue, "%;\n\t\t\tleft: ").concat(leftValue < 0 ? 0 : leftValue, "%;\n\t\t\theight: ").concat(heightvalue > height ? height : heightvalue, "px;\n\t\t\twidth: ").concat(widthValue > width ? width : widthValue, "px;\n\t\t\tborder-radius: ").concat(borderValue < 0 ? 0 : borderValue, "%;\n\t\t\tfilter: blur(").concat(filterValue < 0 ? 0 : filterValue, "px); \n\t\t\t\n\t\t");
    text.style.cssText = "  \n\t\t\ttop: ".concat(323 - document.documentElement.scrollTop, "px;\n\t\t");
  ...
  var str = "Full-stack маркетинг агентство".split("");
  var str2 = "Делаем компании выдающимися".split("");
  var c = str.length;
  var v = str2.length;
